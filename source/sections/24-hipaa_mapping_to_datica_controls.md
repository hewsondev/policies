# 24. HIPAA Mappings to LifeCo Controls

Below is a list of HIPAA Safeguards and Requirements and the LifeCo controls in place to meet those.

| **Administrative Controls** HIPAA Rule | LifeCo Control
--- | ---
...
| **Physical Safeguards** HIPAA Rule | LifeCo Control
--- | ---
...
| **Technical Safeguards** HIPAA Rule | LifeCo Control
---------------- | ----------------
